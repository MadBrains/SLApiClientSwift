...
open class CartItemWithExtra: Codable {
    ...
    public var extra: [CartItem]?


    public init(catalogItemId: UUID?, data: CartItemData?, discountPrice: Double?, id: UUID?, portion: Double?, price: Double?, quantity: Int?, unit: Unit?, extra: [CartItem]?) {
    ...
    public required init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: String.self)
                ...
                extra = try container.decodeIfPresent([CartItem].self, forKey: "extra")
    }
}
