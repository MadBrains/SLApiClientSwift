...
/** Товар с динамическими свойствами и ценами с остатками по магазинам */

open class CatalogItemWithRemains: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: String.self)
                ...
                remains = try container.decodeIfPresent([CatalogItemRemains].self, forKey: "remains")
    }
}
