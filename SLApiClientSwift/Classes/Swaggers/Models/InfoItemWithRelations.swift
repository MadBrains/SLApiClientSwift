...
/** Элемент информационной системы с динамическими свойствами */

open class InfoItemWithRelations: Codable {
    ...
    public init(body: String?, createdAt: Int64?, creator: UUID?, description: String?, id: UUID?, image: String?, _import: Bool?, name: String, updatedAt: Int64?, properties: [IPropertyValue]?) {
        self.body = body
