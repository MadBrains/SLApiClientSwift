...
/** Элемент истории использования механик лояльности */

open class LoyaltyHistory: Codable {
    ...
    public enum Mechanic: String, Codable { 
        ...
        case instagramgroup = "instagramGroup"
        case firstorder = "firstOrder"
    }
