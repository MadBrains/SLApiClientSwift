...
/** Ответ поискового запроса заказов (с агрегациями) */
...
open class OrderResponse: Codable {
    ...
    public var results: [OrderWithRelations]?


    public init(aggregations: Any?, count: Int?, results: [OrderWithRelations]?) {
    ...
    public required init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: String.self)
                ...
                results = try container.decodeIfPresent([OrderWithRelations].self, forKey: "results")
    }
}
