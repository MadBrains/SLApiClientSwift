...
open class ConfirmationQuery: Codable {
    ...
    /** Тип value: phone, email   * email   * phone - \&quot;^[0-9]{11,13}$\&quot; (только числа от 11 до 13 символов)  */
    public var type: ModelType
    /** email or phone */
    public var value: String


    public init(code: String, type: ModelType, value: String) {
        self.code = code
        self.type = type
        self.value = value
    }
