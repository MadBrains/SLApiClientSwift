...
open class DcCard: Codable {
    ...
    public init(number: String, bonus: Float?, description: String?, discount: Float?, firstName: String?, lastName: String?, middleName: String?, phone: String?, type: ModelType) {
        self.number = number
        self.bonus = bonus
