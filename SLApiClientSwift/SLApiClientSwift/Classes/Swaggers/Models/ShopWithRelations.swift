...
open class ShopWithRelations: Codable {
    ...
    public init(address: String?, group: UUID?, id: String?, _import: Bool?, location: Point?, name: String, phones: [String]?, timezone: String?, workTimes: WeekWorkTime?, properties: [IPropertyValue]?) {
